...
urlpatterns = [
    ...
    path('class_dashboard/', recog_views.class_dashboard, name='class_dashboard'),
    path('class_dashboard/<str:class_name>/', recog_views.class_dashboard, name='class_dashboard'),
    path('update_class_selection/<str:class_name>/', recog_views.update_class_selection, name='update_class_selection'),
